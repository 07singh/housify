...
class _ChooseDateTimeScreenState extends State<ChooseDateTimeScreen> {
      ...
      Navigator.push(
        ...
        MaterialPageRoute(
          builder: (context) => LocationScreen(
            ...
            requiredPersons: widget.requiredPersons,
          ),
        ),
      );
    } else {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Colors.black, // black background behind white container
      body: Column(
        children: [
          // Custom AppBar
          SafeArea(
            ...
            child: Container(
              ...
              child: Stack(
                children: [
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            const Text("Include All painting Instruments"),
                          ],
                        ),
                      ],
                    ),
                  ...
                  // Proceed button like Cleaning/Printing style
                  Positioned(
                    bottom: 16,
                    left: 16,
                    right: 16,
